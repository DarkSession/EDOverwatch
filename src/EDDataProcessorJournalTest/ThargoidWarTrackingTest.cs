...
namespace EDDataProcessorJournalTest
{
    ...
    public class ThargoidWarTrackingTest : TestDbContext
    {
        ...
        public async Task Test(string journalLine, long systemAddress, StarSystemThargoidLevelState expectedSystemState, double expectedProgress)
        {
            ...
            Assert.AreEqual(expectedProgress, (double)starSystem.ThargoidLevel.CurrentProgress!.ProgressPercent!);
        }
    }
}
