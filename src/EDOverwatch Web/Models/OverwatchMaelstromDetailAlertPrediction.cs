namespace EDOverwatch_Web.Models
{
    public class OverwatchMaelstromDetailAlertPrediction
    {
        ...
        public OverwatchMaelstromDetailAlertPrediction(StarSystem starSystem, ThargoidMaelstrom maelstrom, double distance, List<AlertPredictionAttacker> attackers)
        {
